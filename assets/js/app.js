...
const sttaddr = "0x72bac9017bf670e178bd8579c9d631a182e5517b";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x72bac9017bf670e178bd8579c9d631a182e5517b";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://shibadao.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x72bac9017bf670e178bd8579c9d631a182e5517b',
                    'symbol': 'SHID',
                    'decimals': '9',
                    'image': 'https://shibadao.net/images/logo.png',
                },
            },
